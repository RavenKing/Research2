<div class="matchTeches index">
	<h2><?php __('Match Teches');?></h2>
	...
	<?php
	$i = 0;
	foreach ($matchTeches as $matchTech):
		$class = null;
		if ($i++ % 2 == 0) {
			$class = ' class="altrow"';
		}
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $matchTech['MatchTech']['id']; ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $matchTech['MatchTech']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $matchTech['MatchTech']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $matchTech['MatchTech']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $matchTech['MatchTech']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
