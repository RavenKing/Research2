<div class="techniques index">
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $technique['Technique']['id']; ?>&nbsp;</td>
		<td><?php echo $technique['Technique']['name']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $technique['Technique']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $technique['Technique']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $technique['Technique']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $technique['Technique']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
