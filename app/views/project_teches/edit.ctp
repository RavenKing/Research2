...
<?php echo $this->Form->create('ProjectTech');?>
	<fieldset>
		<legend><?php __('Edit Project Tech'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ProjectTech.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ProjectTech.id'))); ?></li>
